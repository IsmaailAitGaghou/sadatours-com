...
// 		$booking_country = '';
		...
		if ( is_user_logged_in() ) {
			...
			if ( in_array( 'wp-travel-engine-customer', (array) $user->roles ) ) {
				...
				$booking_phone = isset( $user->user_phone ) ? $user->user_phone : '';
    ...
    'attributes'     => array(
        'data-msg'                      => __( 'Please enter a valid phone number', 'wp-travel-engine' ),
        'data-parsley-required-message' => __( 'Please enter a valid phone number', 'wp-travel-engine' ),
    ),
